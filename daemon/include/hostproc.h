 ...
 * container's own init is a direct clone3() child of kanxeod itself,
 * so a real host ppid-chain walk from any process reaches either a
 * known container root (that process belongs to it) or kanxeod's own
 ...
 * on a real installed system where kanxeod runs as real PID 1) --
