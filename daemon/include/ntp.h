 ...
 *    kanxeod doing the actual clock_settime() call itself anyway --
 ...
 *    config-file push, no signal needed. kanxeod resolves the
 ...
 * kanxeod's own single-threaded epoll loop (ADR-0005/0007).
 */
