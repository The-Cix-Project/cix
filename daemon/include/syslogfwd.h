 ...
 * kernel/kanxeod/audit entries are NOT forwarded, matching the user's
 ...
 * inbound query kanxeod itself initiates and waits on a reply for;
 ...
 * this daemon) -- TAG is always "kanxeod" (identifying this daemon as
