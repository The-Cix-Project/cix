...
$(BUILD)/test_kernelpolicy: test/test_kernelpolicy.c daemon/src/kernelpolicy.c daemon/src/zswap.c daemon/src/persist.c daemon/src/json.c | $(BUILD)
	$(CC) $(DAEMON_CFLAGS) $^ -o $@
