...
SELFTESTS = \
	...
	$(BUILD)/test_docindex $(BUILD)/test_web_vt $(BUILD)/test_web_tree $(BUILD)/test_web_syntax $(BUILD)/test_secrets \
	$(BUILD)/test_clitree \
	...
	$(BUILD)/test_pgpverify $(BUILD)/test_srcdepth $(BUILD)/test_srcupstream $(BUILD)/test_srcpolicy $(BUILD)/test_srcresolve $(BUILD)/test_pipeline $(BUILD)/test_scheduler \
...
$(BUILD)/test_cbsrecipe: test/test_cbsrecipe.c daemon/src/cbsrecipe.c daemon/src/json.c | $(BUILD)
	$(CC) $(CFLAGS) -Idaemon/include $^ -o $@
...
$(BUILD)/test_secrets: test/test_secrets.c | $(BUILD)
	$(CC) $(CFLAGS) test/test_secrets.c -o $@
...
$(BUILD)/test_http_put: test/test_http_put.c test/test_image_fixture.c test/test_floor.c client/src/httpclient.c daemon/src/json.c | $(BUILD)
	$(CC) $(CFLAGS) -Iclient/include -Idaemon/include test/test_http_put.c test/test_image_fixture.c test/test_floor.c client/src/httpclient.c daemon/src/json.c -o $@
