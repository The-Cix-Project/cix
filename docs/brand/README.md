...
The brand system for Cix (the rebrand from ThinC, tracked as issue #121).
...
- Rebrand execution (docs, web UI, binaries, repo name) is scheduled via
  issue #121, not by this folder's existence.
