...
- `cixctl`'s container listing gained a trailing `cmd=...` column (space-joined argv), and the web dashboard's container JSON now carries the field for any future UI use.
