...
Found live on 192.168.15.95, watched directly on the physical/serial console: a sustained flood of `kanxeod: https handshake failed: sslv3 alert certificate unknown` — over 500 occurrences per minute, ongoing. Two real gaps, reported by the user in the same conversation:
