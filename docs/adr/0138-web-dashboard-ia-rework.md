...
- Zero API/daemon changes -- this is entirely a `web/` client-side reorganization. No new endpoint, no changed response shape, nothing for `cixctl` or a direct API caller to adjust to.
