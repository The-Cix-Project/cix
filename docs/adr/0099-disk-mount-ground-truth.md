...
- An operator (or the dashboard, once a Disks view exists) can now tell whether a disk is mounted without caring whether Cix itself did the mounting, or has restarted since.
