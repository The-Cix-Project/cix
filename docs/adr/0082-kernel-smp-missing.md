...
Raised directly by the user reporting real, live-observed memory growth on 192.168.15.95 ("cix's real host") — investigating that surfaced this, a second and more foundational finding, along the way.
