...
## Phase 7 — Routing protocols for containerized VPNs/routers (in progress: parts 1–2 done)
...
**Part 3 is deliberately not designed yet, per Zen** — IP forwarding and static route installation, the piece that turns a multi-homed container into an actual router, is real design work in its own right and will be planned once Part 2 is the settled foundation under it, not before.
