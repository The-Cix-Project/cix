...
| 7 | Routing protocols (containerized VPNs/routers) | 6 | In progress (part 1 done) |
...
## Phase 7 — Routing protocols for containerized VPNs/routers (in progress: part 1 done)
...
- **Part 2 (not designed yet): multi-homed containers** — a container attaches to more than one network at once, the actual routing prerequisite.
- **Part 3 (not designed yet): IP forwarding + static routes** — turns a multi-homed container into a real router.
...
**Part 2 and Part 3 are deliberately not designed yet, per Zen** — multi-homed containers and IP forwarding/static routes are real design work in their own right and will be planned when Part 1 is the settled foundation under them, not before.
