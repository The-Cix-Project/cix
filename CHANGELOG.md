...
### Part 201 (in progress): kernel 6.18.40 rebuild -> a full toolchain-lineage investigation (TCC -> gcc-4.7.4 -> gcc-6.4.0 -> 16.2.0), now paused on a platform-anomaly suspicion
