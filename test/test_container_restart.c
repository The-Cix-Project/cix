...
int main(void)
{
	...
	if (test_data_dir_create(g_data_dir, sizeof(g_data_dir)) != 0)
		return 1;
	snprintf(g_image_root, sizeof(g_image_root), "%s/images/restarttest/v1/rootfs", g_data_dir);
	...
	reset_state();
	{
		...
		snprintf(image_dir, sizeof(image_dir), "%s/images/restarttest", g_data_dir);
