...
int main(void)
{
	...
	check(cix_client_request(&client, "POST", "/v1/containers",
	                         ...
	                         "\"services\":[{\"name\":\"main\",\"on_exit\":\"fail-container\",\"cmd\":[\"/bin/volume_child\"]}]}",
	                         &r) == 0 &&
	          r.status == 400,
	...
	check(cix_client_request(&client, "POST", "/v1/containers",
	                         ...
	                         "\"services\":[{\"name\":\"main\",\"on_exit\":\"fail-container\",\"cmd\":[\"/bin/volume_child\",\"write\"]}]}",
	                         &r) == 0 &&
	          r.status == 201,
	...
	check(cix_client_request(&client, "POST", "/v1/containers",
	                         ...
	                         "\"services\":[{\"name\":\"main\",\"on_exit\":\"fail-container\",\"cmd\":[\"/bin/volume_child\",\"sleep\"]}]}",
	                         &r) == 0 &&
	          r.status == 201,
