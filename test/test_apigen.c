...
int main(void)
{
	...
	else if (atoi(out) != 273)
		fail("apigen found %d operations in the real spec, expected 273 -- if the spec "
	 ...
	 */
	{
		...
		if (defines != 273)
			fail("CLI header has %d path defines, expected one per operation (273)", defines);
		if (methods != 273)
